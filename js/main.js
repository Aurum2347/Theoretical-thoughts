...
import { initCrafting } from './crafting.js'; // ← СИСТЕМА КРАФТА
import { initEasterEggs } from './easterEggs.js'; // ← ДОБАВЛЕНО
...
initContextMenu();
initSelection();
initCrafting(); // ← ЗАПУСК СИСТЕМЫ КРАФТА
initEasterEggs();

// Импорт dragDrop для регистрации обработчиков
import './dragDrop.js';